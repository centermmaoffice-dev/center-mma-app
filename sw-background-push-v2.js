const CENTER_MMA_SW_VERSION = '20260906-1';

self.addEventListener('install', function (event) {
  // Activate this deployed worker immediately instead of leaving it waiting
  // behind an older CENTER MMA service worker.
  self.skipWaiting();
});

self.addEventListener('activate', function (event) {
  // Take control of already-open CENTER MMA pages as soon as this worker activates.
